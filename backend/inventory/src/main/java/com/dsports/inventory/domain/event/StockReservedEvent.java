...
public final class StockReservedEvent extends DomainEvent {
    private final InventoryId inventoryId;
    private final Quantity quantity;
    private final InventoryStatus newStatus;

    public StockReservedEvent(InventoryId inventoryId, Quantity quantity, InventoryStatus newStatus) {
