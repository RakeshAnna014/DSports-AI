...
public final class CheckoutReadyForPaymentEvent extends DomainEvent {
    private final CheckoutId checkoutId;
    private final UUID customerId;
    private final BigDecimal totalAmount;

    public CheckoutReadyForPaymentEvent(CheckoutId checkoutId, UUID customerId, BigDecimal totalAmount) {
